...
public class MoonConfiguredFeatureProvider  extends FabricDynamicRegistryProvider {

    public MoonConfiguredFeatureProvider(FabricDataOutput output, CompletableFuture<RegistryWrapper.WrapperLookup> registriesFuture) {
    ...
    protected void configure(RegistryWrapper.WrapperLookup registries, Entries entries) {
        ...
        MoonConfiguredFeatures.features.forEach(configuredFeatureRegistryKey -> add(registries, entries, configuredFeatureRegistryKey));
    }
