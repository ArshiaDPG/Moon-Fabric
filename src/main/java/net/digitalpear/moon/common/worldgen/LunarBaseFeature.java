...
extends Feature<DefaultFeatureConfig> {
    ...
    public boolean generate(FeatureContext<DefaultFeatureConfig> context) {
        ...
        this.setBlockState(structureWorldAccess, blockPos.up().east(), Blocks.IRON_BARS.getDefaultState().with(PaneBlock.WEST, true));
        this.setBlockState(structureWorldAccess, blockPos.up().west(), Blocks.IRON_BARS.getDefaultState().with(PaneBlock.EAST, true));
        ...
        BlockEntity blockEntity = structureWorldAccess.getBlockEntity(blockPos.up());
        if (blockEntity instanceof DropperBlockEntity) {
            DropperBlockEntity dropperBlockEntity = (DropperBlockEntity)blockEntity;
            dropperBlockEntity.createNbt();
